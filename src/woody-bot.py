...
This code is derived from https://www.fullstackpython.com/blog/build-first-slack-bot-python.html
...
def post_message(slack_client, msg, chan=BOT_CHAN):
    ...
    Swallows and logs any exceptions or slack_client errors.
    :param slack_client: Instance of SlackClient to use for api call.
